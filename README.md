...
<p align="center">
<h4>Lab Topology:</h4>
In this Lab topology the network devices and PCS will be configured to IP configurations from the DHCP server. All the devices are on the same subnet. <br/>
